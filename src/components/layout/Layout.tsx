...
export default function Layout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen w-full flex items-center justify-center md:p-6">
      {/* Phone frame */}
      <div className="relative w-full md:w-[430px] md:h-[900px] md:max-h-[calc(100vh-3rem)] md:rounded-[44px] bg-app md:shadow-phone md:border md:border-border md:overflow-hidden h-screen overflow-hidden flex flex-col">
